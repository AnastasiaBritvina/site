...
class ApplicationForm(ModelForm):
    ...
    emailOfClient = forms.CharField(label='e-mail')
    phoneOfClient = forms.CharField(label='Телефон')
    ...
    class Meta:
        model = Application
        fields = ['nameOfClient', 'emailOfClient', 'phoneOfClient', 'kindOfEvent',
